  ...
  <div class="nav">
    <nav class="navbar navbar-expand-sm ">
       <div class="container-fluid">
          <span class="navbar-text" style="top: 12px"></span>
        </div>
    </nav>
  </div>
...
<nav class="navbar navbar-expand-lg navbar-">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <div class="anchura">
      <form class="d-flex" >
        <input class="form-control me-2"  type="search" placeholder="" aria-label="" v-model="libro" >
         
        <button @click="getsearch" class="btn btn-outline-light" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
...
export default {
    ...
    methods:{
        ...
        async getcategorias(){
          ...
          async getsearch(){
            await axios.get('http://127.0.0.1:8000/api/libro/titulo',{
              titulo:this.libro
            }).then(response=>{
              console.log(response.data)
            }).catch(error=>{
